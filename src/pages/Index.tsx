        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-slate-600 mb-4">
              «Чокнутая СОВА» — это семейный бизнес, который мы ведём вместе уже более 5 лет. Всё началось с маленькой кухни и большой любви к уютным вечерам, а выросло в настоящее дело всей семьи.
            </p>
            <p className="text-slate-600 mb-6">
              Мы сами варим бомбочки, мешаем скрабы и заливаем свечи — небольшими партиями, вручную. Только натуральные масла, никакой агрессивной химии и тестов на животных.
            </p>
            <div className="flex gap-6">
              {[
                ...
                <div key={s.label}>
                  <p className="font-display text-2xl text-owl-pink">{s.value}</p>
